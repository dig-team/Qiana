...
fof(schema_32_f,axiom,(! [X_1, X_2, Y_1, Y_2]: ((equals(X_1, Y_1) & equals(X_2, Y_2)) => equals(f(X_1, X_2), f(Y_1, Y_2))))).
...
fof(schema_33_p,axiom,(! [X_1, Y_1]: ((equals(X_1, Y_1)) => (p(X_1) <=> p(Y_1))))).
...
fof(schema_36_say,axiom,(! [T0]: (reach(T0) => equals(eval(q_say(T0)), say(eval(T0)))))).
fof(schema_36_bel,axiom,(! [T0]: (reach(T0) => equals(eval(q_bel(T0)), bel(eval(T0)))))).
fof(schema_36_f,axiom,(! [T0, T1]: ((reach(T0) & reach(T1)) => equals(eval(q_f(T0, T1)), f(eval(T0), eval(T1)))))).
fof(schema_37_madLove,axiom,(! [T0, T1]: ((reach(T0) & reach(T1)) => equals(eval(q_madLove(T0, T1)), q_madLove(T0, T1))))).
fof(schema_37_dead,axiom,(! [T0]: (reach(T0) => equals(eval(q_dead(T0)), q_dead(T0))))).
fof(schema_37_drinkPotion,axiom,(! [T0]: (reach(T0) => equals(eval(q_drinkPotion(T0)), q_drinkPotion(T0))))).
fof(schema_37_appearDead,axiom,(! [T0]: (reach(T0) => equals(eval(q_appearDead(T0)), q_appearDead(T0))))).
fof(schema_37_p,axiom,(! [T0]: (reach(T0) => equals(eval(q_p(T0)), q_p(T0))))).
...
fof(schema_41_romeo,axiom,equals(eval(q_romeo), romeo)).
fof(schema_41_juliet,axiom,equals(eval(q_juliet), juliet)).
fof(schema_41_friar,axiom,equals(eval(q_friar), friar)).
...
fof(schema_47_q_VAR_2,axiom,(! [T1, T2]: ((reach(T1) & reach(T2)) => equals(sub(q_VAR_1, T1, q_Forall(q_VAR_1, T2)), q_Forall(q_VAR_1, T2))))).
fof(schema_47_q_VAR_0,axiom,(! [T1, T2]: ((reach(T1) & reach(T2)) => equals(sub(q_VAR_1, T1, q_Forall(q_VAR_1, T2)), q_Forall(q_VAR_1, T2))))).
fof(schema_47_q_x0,axiom,(! [T1, T2]: ((reach(T1) & reach(T2)) => equals(sub(q_VAR_1, T1, q_Forall(q_VAR_1, T2)), q_Forall(q_VAR_1, T2))))).
fof(schema_47_q_VAR_1,axiom,(! [T1, T2]: ((reach(T1) & reach(T2)) => equals(sub(q_VAR_1, T1, q_Forall(q_VAR_1, T2)), q_Forall(q_VAR_1, T2))))).
...
fof(schema_48_q_VAR_2_q_x0,axiom,(! [T1, T2]: ((reach(T1) & reach(T2)) => equals(sub(q_VAR_2, T1, q_Forall(q_x0, T2)), q_Forall(q_x0, sub(q_VAR_2, T1, T2)))))).
...
fof(schema_48_q_VAR_0_q_x0,axiom,(! [T1, T2]: ((reach(T1) & reach(T2)) => equals(sub(q_VAR_0, T1, q_Forall(q_x0, T2)), q_Forall(q_x0, sub(q_VAR_0, T1, T2)))))).
...
fof(schema_48_q_x0_q_VAR_2,axiom,(! [T1, T2]: ((reach(T1) & reach(T2)) => equals(sub(q_x0, T1, q_Forall(q_VAR_2, T2)), q_Forall(q_VAR_2, sub(q_x0, T1, T2)))))).
fof(schema_48_q_x0_q_VAR_0,axiom,(! [T1, T2]: ((reach(T1) & reach(T2)) => equals(sub(q_x0, T1, q_Forall(q_VAR_0, T2)), q_Forall(q_VAR_0, sub(q_x0, T1, T2)))))).
fof(schema_48_q_x0_q_VAR_1,axiom,(! [T1, T2]: ((reach(T1) & reach(T2)) => equals(sub(q_x0, T1, q_Forall(q_VAR_1, T2)), q_Forall(q_VAR_1, sub(q_x0, T1, T2)))))).
...
fof(schema_48_q_VAR_1_q_x0,axiom,(! [T1, T2]: ((reach(T1) & reach(T2)) => equals(sub(q_VAR_1, T1, q_Forall(q_x0, T2)), q_Forall(q_x0, sub(q_VAR_1, T1, T2)))))).
...
fof(schema_54,axiom,(! [T_1, T_2]: ((reach(T_1) & reach(T_2)) => reach(f(T_1, T_2))))).
...
fof(schema_58,axiom,(! [T_1, T_2]: ((wft(T_1) & wft(T_2)) => wft(f(T_1, T_2))))).
...
fof(schema_59_p,axiom,(! [T_1]: ((wft(T_1)) => (truthPredicate(q_p(T_1)) <=> p(eval(T_1)))))).
