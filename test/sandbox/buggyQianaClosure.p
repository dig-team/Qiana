...
fof(schema_47_q_VAR_1,axiom,(! [T1, T2]: ((reach(T1) & reach(T2)) => equals(sub(q_VAR_2, T1, q_Forall(q_VAR_2, T2)), q_Forall(q_VAR_2, T2))))).
fof(schema_47_q_x0,axiom,(! [T1, T2]: ((reach(T1) & reach(T2)) => equals(sub(q_VAR_2, T1, q_Forall(q_VAR_2, T2)), q_Forall(q_VAR_2, T2))))).
fof(schema_47_q_VAR_0,axiom,(! [T1, T2]: ((reach(T1) & reach(T2)) => equals(sub(q_VAR_2, T1, q_Forall(q_VAR_2, T2)), q_Forall(q_VAR_2, T2))))).
fof(schema_47_q_VAR_2,axiom,(! [T1, T2]: ((reach(T1) & reach(T2)) => equals(sub(q_VAR_2, T1, q_Forall(q_VAR_2, T2)), q_Forall(q_VAR_2, T2))))).
